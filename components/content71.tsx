            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                <span className="text-accent-foreground font-bold">
                  comprehensive understanding of a case's strengths and
                  weaknesses
                </span>
                . By evaluating evidence, assessing legal claims, and
                ...
                strategic planning and helps set realistic expectations for
                clients.
              </p>
            </div>
