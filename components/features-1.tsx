        ...
        <section className="bg-white py-16 md:py-32 dark:bg-transparent">
            <div className="@container mx-auto max-w-5xl px-6">
                <div className="text-center">
                    <h2 className="text-balance text-3xl px-4 sm:text-4xl font-semibold lg:text-5xl">Built to cover your needs</h2>
                    <p className="mt-4 px-4 sm:px-0 text-sm sm:text-base">Libero sapiente aliquam quibusdam aspernatur, praesentium iusto repellendus.</p>
                </div>
                <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-4 sm:gap-6 *:text-center md:mt-16">
